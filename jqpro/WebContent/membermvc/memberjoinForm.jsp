		...
		<form action="">
			...
			<div class="mb-3 mt-3">
				<label for="id">아이디:</label> <input type="button" value="중복검사"
					class="btn btn-outline-primary btn-sm"> <span id="checkid"></span>
			...
			<div class="mb-3 mt-3">
				<label for="tel">전화번호:</label> <input type="text"
					class="form-control" id="tel" name="mem_hp">
			</div>

			<div class="mb-3 mt-3">
				<label for="bir">생일 :</label> <input type="date"
					class="form-control" id="bir" name="mem_bir">
			</div>

			<div class="mb-3 mt-3">
				<label for="zip">우편번호:</label> <input type="button" value="번호검색"
					class="btn btn-outline-primary btn-sm"> <input type="text"
					class="form-control" id="zip" name="mem_zip">
			</div>

			<div class="mb-3 mt-3">
				<label for="add1">주소:</label> <input type="text"
					class="form-control" id="add1" name="mem_add1">
			</div>
			<div class="mb-3 mt-3">
